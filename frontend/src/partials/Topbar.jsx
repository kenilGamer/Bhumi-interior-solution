...
function Topbar() {
  const data = [
    ...
    { icon: <FaInstagram />, link: "https://www.instagram.com/bhumi_interior_solution", label: "Instagram" },
          ...
          <div className="flex  max-sm:flex-col items-center justify-between gap-3 text-xs">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <div className="flex items-center gap-1.5 text-white hover:text-[#D3AA62] transition-all duration-300 group">
                ...
                <a href="tel:9624538770" className="hover:underline font-medium text-sm">+91 9624538770</a>
              </div>
              <div className="flex items-center gap-1.5 text-white hover:text-[#D3AA62] transition-all duration-300 group">
